...
/** Treble layout choices shown inside the Layout settings. */
export type TrebleLayout = TrebleSystem | "piano";

/** Preset instrument ranges for the chromatic-button treble side. */
export type TrebleSizePreset = "small" | "full" | "large";

/** Preset instrument ranges for the piano treble side. */
 ...
 */
export type FinderTarget = "treble" | "stradella";
...
/** Chord root octave choices used by the Finder chord workflow. */
export type FinderChordOctave = 2 | 3 | 4 | 5 | 6;

/** Stradella bass-button sound voicing choices. */
export type StradellaBassVoicing = "single-low" | "low-and-middle" | "single-middle";

/** Stradella chord-finder search strategy. */
export type StradellaChordFinderMode = "bass-only" | "chord-buttons-only" | "bass-and-chords";

/** ABC Player mapping strategy for the treble side. */
export type AbcTrebleChordSymbolsMode = "ignore" | "play";

/** ABC Player mapping strategy for the Stradella side. */
export type AbcStradellaMode = "bass-notes-only" | "chord-symbols-only" | "bass-notes-and-chord-symbols";

/** Bass Pattern Player chord voicing behavior. */
export type BassPatternChordVoicing = "simple" | "full";

/** Download formats supported by the top-bar download control. */
export type DownloadFormat = "svg" | "png";

/** Controls the density of sidebar controls. */
...
export type DiagramButton = {
  ...
  */
  ...
  /* Optional piano-key geometry. */
  visualShape?: "circle" | "piano-white-key" | "piano-black-key";
  width?: number;
  height?: number;
};
